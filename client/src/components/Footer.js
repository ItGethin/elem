...
class Footer extends Component {
  ...
  render() {
    return (
                <footer>
                  <ul>
                        <OldSchoolMenuLink activeOnlyWhenExact={true} to="/" label="主页" list={this.state.list[0]} list1={this.state.list1[0]}/>
                    
                        <OldSchoolMenuLink activeOnlyWhenExact={true} to="/fund" label="发现" list={this.state.list[1]} list1={this.state.list1[1]}/>
                    
                        <OldSchoolMenuLink activeOnlyWhenExact={true} to="/order" label="订单" list={this.state.list[2]} list1={this.state.list1[2]}/>
                    
                        <OldSchoolMenuLink activeOnlyWhenExact={true} to="/user" label="我的" list={this.state.list[3]} list1={this.state.list1[3]}/>
...
const OldSchoolMenuLink = ({ label, to, activeOnlyWhenExact,list,list1 }) => (
  <Route path={to} exact={activeOnlyWhenExact} children={({ match }) => (
    <li className={match ? 'active' : ''}>
                        <Link to={to}>
                            <img src={match ? list1 : list} alt=""/>
                            <span>{label}</span>
                        </Link>
    </li>
  )}/>
